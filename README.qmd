...
# Export data.
schsp <- as(schsf, "Spatial")
kml_open(file.name = "data/final_data/geodata/survey_schedule.kml",
 overwrite = TRUE
 )
sl <- schsf$year >= this_year
clr <- rep(NA, length(sl))
clr[schsf$target_species[sl] %in% c("fathead minnow", "northern pike", "rainbow trout")] <- "#0066FF" 
clr[schsf$target_species[sl] == "elodea"] <- "#3AA655"
clr[schsf$target_species[sl] == "dreissenid mussels"] <- "#FD5B78"
kml_layer.SpatialPoints(schsp[sl,],
 subfolder.name = "Invasive surveys waterbodies",
 points_names = paste(schsp$waterbody_name[sl], schsp$year[sl], schsp$target_species[sl], schsp$surveyors[sl]),
 shape = "http://maps.google.com/mapfiles/kml/pal2/icon18.png",
 colour = "#0066FF",
 LabelScale = 0.8
 )
kml_close(file.name = "data/final_data/geodata/survey_schedule.kml")
