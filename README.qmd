...
# Export data.
st_write(schsf[schsf$year >= this_year,], dsn = "data/final_data/geodata/survey_schedule.kml",
 delete_dsn = TRUE)
st_write(schsf[schsf$year >= this_year,], dsn = "data/final_data/geodata/survey_schedule.shp",
 delete_dsn = TRUE)
st_write(schsf[schsf$year < this_year,], dsn = "data/final_data/geodata/past_surveys.kml",
 delete_dsn = TRUE)
st_write(schsf[schsf$year < this_year,], dsn = "data/final_data/geodata/past_surveys.shp",
 delete_dsn = TRUE)
```
...
```{r scheduletab, echo=FALSE}
#| label: tbl-past
#| tbl-cap: "Past aquatic invasive species surveys in Peninsula waterbodies. Acronyms are the same as in @tbl-coop."
#| tbl-cap-location: top
...
Data were processed using R, version 4.2.2 [@RCoreTeam2022] and the R packages readxl, version 1.4.1 [@WickhamBryan2022] and sf, version 1.0-9 [@Pebesma2018].
